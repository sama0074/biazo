													...
													<div class="card-body">
														...
														<div class="row" style="margin-bottom: 30px">
															<div class="col col-md-6">
																...
																<input type="text" name="name" class="form-control" placeholder="e.g Pink exotic ladies blouse for ladies who are under 30 years" required>
															</div>
															<?php
															...
															<div class="col col-md-3">
																...
																<input type="text" name="created_by" readonly class="form-control" value="<?php echo $row['member_name']?>" required>
															</div>
														</div>
														<div class="row" style="margin-bottom: 30px">
																	...
																	<div class="avatar-container">
																		<div class="avatar-upload">
																			<div class="avatar-edit">
																				<input type='file' id="imageUpload" name="main_image" accept=".png, .jpg, .jpeg" required />

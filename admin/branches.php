...
<main class="content">
	<div class="container-fluid p-0">
		...
		<h1 class="h3 mb-3">Add Branches</h1>
								...
								<div class="col col-md-5">
									<div class="homeCard">
										<div class="card-content">
											<div class="card-header"><h5><i class="fas fa-list"></i> Add Branch</h5></div>
											<div class="card-body">
												<form action="#0" method="POST">
													...
													<div class="text-center">
														<button name="create_department" type="submit" class="btn btn-success">Add</button>
													</div>
												</form>
											</div>
										</div>

<?php
        ...
        $bal = $_GET['balance'];
        $l_pay = $_GET['ldate'];
        $message = "Thanks for your purchase today $date at Biazo. Your order No is $trans_id and advanced amount is $total_amount Frs. Your balance is $bal to be paid latest on $l_pay.";

    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-md-8 acc_header">
                <h2 style="margin-bottom:50px">Fast food order history</h2>
                ...
                <div class="basket_header">
                    <div class="row">
                        <div class="col col-md-5" style="font-weight: 600; color: gray">FOOD</div>
                        <div class="col col-md-1" style="font-weight: 600; color: gray">QTY</div>
                    ...
                    <div class="card" style="margin-bottom:10px; border: none; border-radius: 20px; box-shadow:0px 0px 8px -2px grey;">
                        <div class="card-content">
                            <div class="card-body" style="padding: 0px !important">
                                <div class="row" >
                                    <div class="col col-md-5 basket_item_right_border">
                                        <div class="row">
                                    ...
                                    <div class="col col-md-1 basket_item_right_border">
                                    ...
                                    <div class="col col-md-2" style="padding: 1.2rem">
                                        <h5 class="text-center" style="color: green">3,000 XAF</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
